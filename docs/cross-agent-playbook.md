...
5. **heartbeat×交互竞态纪律（2026-09-10 实战教训：自动轮顶掉了待用户回答的 A/B/C 裁决弹窗并自主代答）**：①heartbeat 轮遇到「待用户回答的挂起问题」不得代答——以纯文本重呈问题后结束本轮；②裁决类请求一律**文本+弹窗双轨**发出（弹窗随轮次易逝，文本跨轮存活）；③人机交互密集期（实战指挥中）heartbeat 降档 30 分钟或暂停
